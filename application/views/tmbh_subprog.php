...
<br><br><br>
  ...
  <?php
      echo form_open('c_jadwal/tambah_subprog');
        echo '<center><h3>Form Tambah Subprogram</h3></center>
          ...
          <div class="row">
            <div class="large-12 columns">
              <tr>
                <td>ID Absen</td>
                <td>:</td>
                <td>'.form_input('idsubprog',$newID,'readonly').'</td>
              </tr>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="large-12 columns">
              <tr>
                ...
                <td>:</td>  
                <td>
                  <select name="namaprogram">
                    <option value="kosong">- Pilih nama program -</option>
                    ';
                    foreach ($dropdown_program->result_array() as $row) {
                      echo "<option value='". $row['idprogram'] ."'>Program : ".$row['nmprogram'] ."</option>";
                    }
                    echo '
                  </select>
                </td>

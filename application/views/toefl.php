...
<nav class="top-bar" data-topbar>
  <ul class="title-area">
    <!-- TITLE AREA -->
      <li class="name">
        <h1>
          <a href="<?php echo base_url()?>c_dtpegawai/page">
            ADMIN ELFAST
          </a>
        </h1>
      </li>
...
<br><br><br>
  ...
  <div class="row">
    <div class="large-12 medium-9 columns panel">
      <h2 id="tables" style="text-align:center;">Jadwal TOEFL</h2>
        <br><br>
          <table>
            <thead>
              <tr>
            ...
            <tbody>
              <?php echo '<tr>';
                $i=1;
                  foreach($querytoefl->result_array() as $rows) {
                    echo "<td>".$i."</td>";
                    ...
                    echo "<td>".anchor('c_toefl/form_update_toefl/'.$rows['idjadwal'],'update', array('class' => 'button'))."</td>";
